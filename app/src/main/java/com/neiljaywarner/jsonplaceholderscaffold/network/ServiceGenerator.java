...
import com.neiljaywarner.jsonplaceholderscaffold.BuildConfig;
...
// this is pretty much from futurestud.io
// it is left in java mostly to show easy interop
...
public class ServiceGenerator {
    ...
    private static String sPasswordAuthToken = null;
    ...
    private static <S> S createService(Class<S> serviceClass, final String authToken) {
        ...
        // Note: filter or control-f with OkHttp" as the tag, but we can customize this if desired.
     ...
     * @return
     */
    public static WebServiceApi createBearerKeyService(String credentials) {
     ...
     * @return
     */
    public static WebServiceApi createBearerKeyDeferredService(String credentials) {
